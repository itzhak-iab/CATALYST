...
4. **שאלות ממוקדות (חשוב — תמיד חדשות!)**: לכל מניה, ייצר 2-3 שאלות **חדשות לגמרי** שמשקיע צריך לשאול את עצמו **ברגע הזה**. אל תחזור על שאלות כלליות או גנריות. השאלות חייבות להתבסס על אירועים ונתונים **עדכניים** — מה שקורה בימים/שבועות האחרונים. כל ריצה חייבת לייצר שאלות שונות מריצות קודמות. התייחס לנתוני השוק הנוכחיים, לחדשות האחרונות, ולמגמות הרגע.
...
- questions: 2-3 שאלות **חדשות לחלוטין** שמתייחסות למצב הנוכחי (לא שאלות גנריות). כל שאלה חייבת להתבסס על עובדה או אירוע מהימים האחרונים
